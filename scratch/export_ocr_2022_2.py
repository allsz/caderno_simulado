...
pdf_path = Path('provas/REVALIDA-2022-2_PV_objetiva.pdf')
...
async def export_all():
    ...
    Path('scratch/revalida_2022_2_full_ocr.txt').write_text('\n\n'.join(pages_text), encoding='utf-8')
    print('OCR completo salvo em scratch/revalida_2022_2_full_ocr.txt')
