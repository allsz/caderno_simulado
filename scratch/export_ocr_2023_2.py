...
pdf_path = Path('provas/REVALIDA-2023_2_PV_objetiva_regular.pdf')
...
async def export_all():
    ...
    Path('scratch/revalida_2023_2_full_ocr.txt').write_text('\n\n'.join(pages_text), encoding='utf-8')
    print('OCR completo salvo em scratch/revalida_2023_2_full_ocr.txt')
